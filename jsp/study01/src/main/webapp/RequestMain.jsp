...
<%--            input 태그의 name 속성은 서버에서 데이터를 구별하는 변수명으로 사용 됨 --%>
        ...
        <div class="my-3">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="gender-women" name="gender" value="woman">
                <label for="gender-women" class="form-check-label">여자</label>
            </div>
        </div>
        ...
        <div class="my-3">
            ...
            <div class="form-check form-check-inline">
<%--                input 태그의 type이 checkbox일 경우 input 태그들의 name 속성값이 동일하면 서버 데이터 전송 시 배열로 전달함--%>
        ...
        <div class="my-3">
            ...
            <textarea cols="5" rows="5" class="form-control" id="comment" name="comment"></textarea>
        </div>
